...
export const createBook = bookData => {
  return async dispatch => {
    try {
      ...
      const { data } = await API.post('/api/books', bookData, config);
...
export const deleteBook = id => {
  return async dispatch => {
    try {
      ...
      const { data } = await API.delete(`/api/books/${id}`, config);
      dispatch({
...
export const fetchBook = (id, bookData) => {
  return async dispatch => {
    try {
      ...
      const { data } = await API.get(`/api/books/${id}`, bookData, config);
...
export const updateBook = (id, bookData) => {
  return async dispatch => {
    try {
      ...
      const { data } = await API.put(`/api/books/${id}`, bookData, config);
      dispatch({
